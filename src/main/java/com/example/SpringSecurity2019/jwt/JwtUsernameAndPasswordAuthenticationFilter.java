...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            UsernameAndPasswordAutenticationRequest authenticationRequest = new ObjectMapper().
                    readValue(request.getInputStream(), UsernameAndPasswordAutenticationRequest.class);
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        response.addHeader(jwtConfig.getAuthorizationHeader(), jwtConfig.getTokenPerfix() + token);
    }
}
